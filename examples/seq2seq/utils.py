...
def build_compute_metrics_fn(task_name: str, tokenizer: PreTrainedTokenizer) -> Callable[[EvalPrediction], Dict]:
    ...
    def summarization_metrics(pred: EvalPrediction) -> Dict:
        ...
        metrics.update({"gen_len": summ_len})
...
def calculate_sentence_trans_cosine(
    ...
    """Calculate cosine similarity using the sentence-transformers package.
...
def calculate_w2v_cosine(
    pred_lns: List[str],
    tgt_lns: List[str]
):
    """Calculate cosine similarity using word 2 vec.
